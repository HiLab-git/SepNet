...
from Training.util.parse_config import parse_config
...
def evaluation(folder, classnum=6, save=False):
    ...
    for patient in patient_list:
        s_name = os.path.join(folder, patient + '/label.nii.gz')
        g_name = os.path.join(folder, patient + '/OverlayInterSeg.nii.gz')
...
#         exit()
folder = '/lyc/Head-Neck-CT/3D_data/test/'
evaluation(folder, classnum=5, save=False)
